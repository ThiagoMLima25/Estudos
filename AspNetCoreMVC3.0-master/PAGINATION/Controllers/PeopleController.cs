...
namespace PAGINATION.Controllers
{
    public class PeopleController : Controller
    {
        ...
        {
            const int itensPerPage = 5;
            int numberPage = (page ?? 1);
            return View(await _context.Peoples.ToPagedListAsync(numberPage, itensPerPage));
        }
        ...
        public async Task<IActionResult> Create([Bind("PeopleId,Name,Old")] People people)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PeopleId,Name,Old")] People people)
        {
